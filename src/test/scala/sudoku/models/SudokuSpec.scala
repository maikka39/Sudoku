...
class SudokuSpec extends AnyWordSpec with Matchers {
  ...
  "RegularSudoku" should {
    ...
    "calculate the correct fieldGroups for a 6x6 grid" in {
      ...
      sudoku.fieldGroups mustBe Seq(
        Seq(Position(0, 0), Position(0, 1), Position(0, 2), Position(1, 0), Position(1, 1), Position(1, 2)),
        Seq(Position(0, 3), Position(0, 4), Position(0, 5), Position(1, 3), Position(1, 4), Position(1, 5)),
        Seq(Position(2, 0), Position(2, 1), Position(2, 2), Position(3, 0), Position(3, 1), Position(3, 2)),
        Seq(Position(2, 3), Position(2, 4), Position(2, 5), Position(3, 3), Position(3, 4), Position(3, 5)),
        Seq(Position(4, 0), Position(4, 1), Position(4, 2), Position(5, 0), Position(5, 1), Position(5, 2)),
        Seq(Position(4, 3), Position(4, 4), Position(4, 5), Position(5, 3), Position(5, 4), Position(5, 5))
      )
    }
